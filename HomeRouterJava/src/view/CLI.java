...
public class CLI extends javax.swing.JPanel {
	...
	public CLI(String host, int port, JTabbedPane Tab, int index, MainInterface mi) throws ConnectException, SocketException, IOException {
		...
		GUISolutionModel GuiSol = new GUISolutionModel(ConsolejTextArea, ClockjLabel, InterfacesjLabel, TypejLabel, IosjLabel, DyRjList, RjList, SerialjTabbedPane, FastEthernetjTabbedPane, Tab, index);
		...
		// Essas 6 linhas a� embaixo d�o um show run e pegam as rotas
		// e a vers�o do IOS, caso voc� tenha algum problema comente-as
	...
	// preenche lista de rotas est�ticas
