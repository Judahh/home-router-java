...
public class CLI extends javax.swing.JPanel {
	...
	public CLI(String host, int port, JTabbedPane Tab, int index, MainInterface mi) throws ConnectException, SocketException, IOException {
		...
		// Essas 6 linhas aí embaixo dão um show run e pegam as rotas
		// e a versão do IOS, caso você tenha algum problema comente-as
	...
	private void parseShowRunInfo(String info) {
		...
		for (int i = 0; i < infoarray.length; i++) {
			if (infoarray[i].contains("version")) {
				...
				jLabel19.setText("Cisco 1700v v1.5 with IOS version " + version);
			}
	...
	// preenche lista de rotas estáticas
	...
	private void initComponents() {
		...
		SwitchingjFrame.setPreferredSize(new java.awt.Dimension(178, 157));
		...
		ConnectivityjFrame.setPreferredSize(new java.awt.Dimension(229, 148));
