...
public class LevelHandler {
    ...
    public boolean checkLevel(){//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        try {
            //String[] possibilities=new String[]{"Login: ","login: ","User: ","user: ","Password: ","password: ","Pass: ","pass: "};
...
//            Possibilities.addAll(Arrays.asList(possibilities));
            ...
            ArrayList<String> arrayReceived= connection.arrayListReadUntil(possibilitiesV);
            ...
            //---------------------------------------------------------------------------------------------------
//            Aqui em baixo ele ira verificar se foi uma informacao se for ele manda para o metodo que a tratara 
