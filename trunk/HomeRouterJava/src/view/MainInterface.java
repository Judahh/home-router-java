...
public class MainInterface extends javax.swing.JFrame{
	...
	private void initComponents(){
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				ConnectWindow.class.getResource("/resources/router icon.png")));
	...
	private void InterfacesStatusjMenuItemActionPerformed(
			java.awt.event.ActionEvent evt){// GEN-FIRST:event_InterfacesStatusjMenuItemActionPerformed
		if(jTabbedPane1.getSelectedIndex() != 0){
			cliArray.get(jTabbedPane1.getSelectedIndex() - 1).InterfacesStatusjFrame
					.setVisible(true);
		}
	}// GEN-LAST:event_InterfacesStatusjMenuItemActionPerformed

	private void InterfacesSerialTypejMenuItemActionPerformed(
			java.awt.event.ActionEvent evt){// GEN-FIRST:event_InterfacesSerialTypejMenuItemActionPerformed
		if(jTabbedPane1.getSelectedIndex() != 0){
			cliArray.get(jTabbedPane1.getSelectedIndex() - 1).InterfacesSerialTypejFrame
					.setVisible(true);
		}
	...
	private void TelnetPortCheckBoxActionPerformed(
			java.awt.event.ActionEvent evt){// GEN-FIRST:event_TelnetPortCheckBoxActionPerformed
	...
	private void SettingsjMenuItemActionPerformed(java.awt.event.ActionEvent evt){// GEN-FIRST:event_SettingsjMenuItemActionPerformed
		if(jTabbedPane1.getSelectedIndex() != 0){
			...
			cliArray.get(jTabbedPane1.getSelectedIndex() - 1).SettingsjFrame
					.setVisible(true);
		}
	...
	private void RoutingjMenuItemActionPerformed(java.awt.event.ActionEvent evt){// GEN-FIRST:event_RoutingjMenuItemActionPerformed
		if(jTabbedPane1.getSelectedIndex() == 0){
			...
			cliArray.get(jTabbedPane1.getSelectedIndex() - 1).RoutingjFrame
					.setVisible(true);
		}
	}// GEN-LAST:event_RoutingjMenuItemActionPerformed

	private void SwitchingjMenuItemActionPerformed(
			java.awt.event.ActionEvent evt){// GEN-FIRST:event_SwitchingjMenuItemActionPerformed
		if(jTabbedPane1.getSelectedIndex() != 0){

			cliArray.get(jTabbedPane1.getSelectedIndex() - 1).SwitchingjFrame
					.setVisible(true);
		}
	}// GEN-LAST:event_SwitchingjMenuItemActionPerformed

	private void ConnectivityjMenuItemActionPerformed(
			java.awt.event.ActionEvent evt){// GEN-FIRST:event_ConnectivityjMenuItemActionPerformed
		if(jTabbedPane1.getSelectedIndex() != 0){

			cliArray.get(jTabbedPane1.getSelectedIndex() - 1).ConnectivityjFrame
					.setVisible(true);
		}
	}// GEN-LAST:event_ConnectivityjMenuItemActionPerformed

	private void InterfacesConfigjMenuItemActionPerformed(
			java.awt.event.ActionEvent evt){// GEN-FIRST:event_InterfacesjMenuItemActionPerformed
		if(jTabbedPane1.getSelectedIndex() != 0){

			cliArray.get(jTabbedPane1.getSelectedIndex() - 1).InterfacesConfigjFrame
					.setVisible(true);
