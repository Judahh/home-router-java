...
public class RouterHandler {
    ...
    public GUISolutionModel getGUISolution() {
        return routerLevel.getInfo().getGUISol();
    }
    ...
    public void setVTYPass(String pass) {
        ...
        this.routerLevel.getAuth().setPassword(pass);
    }
    ...
    public void setEnablePass(String pass) {
        ...
        this.routerLevel.getAuth().setPasswordB(pass);
    }
    ...
    public void setEnableSecretPass(String secret) {
        ...
        this.routerLevel.getAuth().setPasswordB(secret);
    }
    ...
    public void showIpInterfaceBrief() {
        ...
        this.routerLevel.sendCommand("show ip interface brief\r\n");
    }
