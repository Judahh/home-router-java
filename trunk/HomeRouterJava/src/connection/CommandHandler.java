...
public class CommandHandler {
    ...
    public enum Prompt {
        ...
        ,ca_identityB
        ,cfg_lan_Ether_10B
        ,cfg_adap_Ether_10_1B
        ,config_cert_chainB
        ,config_controllerB
        ,config_ctrl_casB
        ,config_crypto_mapB
        ,config_crypto_transB
        ,config_dialpeerB
        ,config_ext_naclB
        ,config_std_naclB
        ,config_hubB
    ...
    public String getCMD(Prompt prompt) {//---------------------------------------------------------------------------------------------------------------------------------------------------------------
        switch (prompt) {//Todos os comandos estao no Excel (alguns comandos aqui presentes podem ser variaveis tem que implementar isto tb)
            case B:
                return "enable\r\n";
            case configB:
